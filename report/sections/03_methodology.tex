...
While \cite{ribeiro2021} used anatomical features as their edge values, we instead used the distance between two
neighboring vertices. To investigate whether the curvature in the response distribution, which arises from cortical
...
$20\%$ of the meshes (98, 33 and 33 meshes), using the same split for all seven models. We trained with a
...
In total we trained seven networks that differ only in the distance function used to compute the edge values
